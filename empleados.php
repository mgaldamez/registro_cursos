...
if(isset($_POST['guardar']) ){
	...
	$nResult = $userClass->newEmp($us, $InputEmpNombre,$InputEmpApellido,$InputEmpFechaNac,$InputEmpDepto,$InputEmpGenero,$InputEmpCargo,$InputEmpNivelAcad,$InputEmpFechaIng);
	...
	$InputEmpNivelAcad = $_POST['InputEmpNivelAcad'];
	$InputEmpFechaIng = $_POST['InputEmpFechaIng'];
	$uResult = $userClass->updateEmp($us,$InputEmpNombre,$InputEmpApellido,$InputEmpFechaNac,$InputEmpGenero,$InputEmpDepto,$InputEmpCargo,$InputEmpNivelAcad,$InputEmpFechaIng,$idEmpleado);
      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				  ...
				  <div class="row">
					  ...
					  <input type="hidden" value="<?php if(isset($idEmpleado)){ echo $idEmpleado; } ?>" name="idEmpleado"/>
						  <div class="col-lg-6">
							  ...
							  <div class="form-group">
								  <label for="InputEmpDepto" class="col-sm-3 control-label">Ubicacion:</label>
								  <div class="input-group col-md-5">
								  <select name="InputEmpDepto" class="selectpicker" data-width="400px">
								  <option <?php if($detById['msj']!=true){ echo 'selected'; } ?> >--Selecionar Ubicacion--</option>
								    <?php 
          ...
          <div class="table-responsive">
            <table id="empTable" class="table table-striped " cellspacing="0">
              <thead>
                <tr>
					...
					if($valor['emp_genero']=='M'){
						...
						$valor['emp_genero']='Femenino';
				  			...
				  			echo "<tr>
								  ...
								  ";
				                  echo '<td><a alt="Actualizar" href="empleados.php?page='.$page.'&type='.$type.'&action=edit&idEmpleado='.$valor['emp_id'].'"><img alt="Actualizar" src="images/edit-24.png" /></a>&nbsp;&nbsp;<a alt="Eliminar" href="empleados.php?page='.$page.'&type='.$type.'&action=delete&idEmpleado='.$valor['emp_id'].'"><img alt="Eliminar" src="images/delete-24.png" /></a>&nbsp;&nbsp;<a  target="_blank" onClick="'; echo "window.open(this.href, this.target, 'width=800,height=600'); return false;"; echo '" alt="Detalle" href="empCurso.php?page=Cursos de Empleado&idEmpleado='.$valor['emp_id'].'"><img alt="Detalle" src="images/report-24.png" /></a>&nbsp;&nbsp;</td>
				                </tr>';
