...
Class Curso{
	...
	function newCurso($user,$crs_nombre,$crs_tipo,$crs_jornada,$crs_ini,$crs_fin,$crs_patrocinador,$crs_status){
		...
		$sql="INSERT INTO tb_cursos (crs_nombre, crs_tipo, crs_jornada, crs_ini, crs_fin, crs_patrocinador, crs_status) VALUES ('$crs_nombre','$crs_tipo','$crs_jornada','$crs_ini','$crs_fin','$crs_patrocinador','$crs_status')";
	...
	function updateCurso($user,$crs_nombre,$crs_tipo,$crs_jornada,$crs_ini,$crs_fin,$crs_patrocinador,$crs_status,$crs_id){
		$crs_nombre=str_replace($this->replace,"",(strip_tags($crs_nombre)));
		$crs_tipo=str_replace($this->replace,"",(strip_tags($crs_tipo)));
		...
		$sql="update tb_cursos set crs_nombre= '$crs_nombre',crs_tipo = '$crs_tipo',crs_jornada='$crs_jornada',crs_ini='$crs_ini',crs_fin='$crs_fin',crs_patrocinador='$crs_patrocinador',crs_status='$crs_status' where crs_id = $crs_id";
		$rs=$this->conn->execute($sql);
