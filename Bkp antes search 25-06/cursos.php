...
if(isset($_POST['guardar']) ){
	...
	$nResult = $userClass->newCurso($us, $InputCrsNombre,$InputCrsTipo,$InputCrsJornada,$InputCrsIni,$InputCrsFin,$InputCrsPat,$InputCrsStat);
	...
	$InputCrsPat = $_POST['InputCrsPat'];
	$InputCrsStat = $_POST['InputCrsStat'];
	$uResult = $userClass->updateCurso($us,$InputCrsNombre,$InputCrsTipo,$InputCrsJornada,$InputCrsIni,$InputCrsFin,$InputCrsPat,$InputCrsStat,$idCurso);
						  ...
						  <div class="col-lg-6">
							  ...
							  <div class="form-group">
								  ...
								  <div class="input-group col-sm-9">
									  <input type="text" class="form-control" id="InputCrsNombre" value="<?php if($detById['msj']==true){ echo $detById['data'][0]['crs_nombre']; }?>" name="InputCrsNombre" placeholder="Nombre del curso" maxlength="30" required>
							  ...
							  <div class="form-group">
								  <label for="InputCrsJornada" class="col-sm-3 control-label">Jornada:</label>
								  <div class="input-group col-sm-9">
									  <input type="text" class="form-control" id="InputCrsJornada" value="<?php if($detById['msj']==true){ echo $detById['data'][0]['crs_jornada']; }?>" name="InputCrsJornada" placeholder="Jornada" maxlength="30" required>
									<span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>  
								  </div>
							  </div>
							  <div class="form-group">
					...
					if($valor['crs_status']=='A'){
						...
						$valor['crs_status']='Inactivo';
				  			...
				  			echo "<tr>
								  ...
								  ";
				                  echo '<td><a alt="Actualizar" href="cursos.php?page='.$page.'&type='.$type.'&action=edit&idCurso='.$valor['crs_id'].'"><img alt="Actualizar" src="images/edit-24.png" /></a>&nbsp;&nbsp;<a alt="Eliminar" href="cursos.php?page='.$page.'&type='.$type.'&action=delete&idCurso='.$valor['crs_id'].'"><img alt="Eliminar" src="images/delete-24.png" /></a>&nbsp;&nbsp;</td>
				                </tr>';
