			  ...
			  if($result["msj"]==true){
			  	...
			  	foreach($data as $valor){
					  if($valor['opc_orden']==0){
							...
							echo '<li><a href="'; echo $valor['opc_action']; echo "?page=".$valor['opc_label']."&type="; echo $valor['menu_type_id']; echo '">'; echo $valor['opc_label']; echo '</a></li>';	
						}
				  }
			  }
		  ?>
