					  ...
					  <input type="hidden" value="<?php if(isset($idDepto)){ echo $idDepto; } ?>" name="idDepto"/>
						  <div class="col-lg-6">
							  ...
							  <div class="form-group">
								  <label for="InputDeptoNombre" class="col-sm-3 control-label">Departamento:</label>
								  <div class="input-group col-sm-9">
									  <input type="text" class="form-control" id="InputDeptoNombre" value="<?php if($detById['msj']==true){ echo $detById['data'][0]['dpt_nombre']; }?>" name="InputDeptoNombre" placeholder="Departamento" maxlength="30" required>
							  ...
							  <div class="form-group">
								  ...
								  <div class="input-group col-sm-9">
									  <input type="text" class="form-control" id="InputDeptoDesc" value="<?php if($detById['msj']==true){ echo $detById['data'][0]['dpt_desc']; }?>" name="InputDeptoDesc" placeholder="Ingresar Descripcion" maxlength="100" required>
									<span class="input-group-addon"><span class="glyphicon glyphicon-asterisk"></span></span>  
								  </div>
							  </div>
