...
Class RptCurso{
	...
	function viewCursoById($crs_id){
			$sql="select crs_id, crs_nombre, crs_tipo, crs_jornada, crs_ini, crs_fin, crs_patrocinador, crs_status, p.pat_nombre from tb_cursos c join tb_patrocinadores p on c.crs_patrocinador= p.pat_id where crs_id=$crs_id";
