...
--
-- Servidor: localhost
-- Tiempo de generación: 01-06-2016 a las 05:08:21
...
--
-- Base de datos: `rreesvco_sys_cursos`
--
...
INSERT INTO `db_sys_cursos`.`tb_departamentos` (`dpt_id`, `dpt_nombre`, `dpt_desc`) 
VALUES (NULL, 'Informatica', 'Departamento de Tecnologias de la Informacion');
...
(1, 'Marvin', 'Galdamez', '1994-05-06', 'M', 'Programador Analista', 'Ingeniero', 'Santa Elena', '2014-03-24'),
...
(7, 'Detalle de Curso', NULL, 1000, 6, 'A');
