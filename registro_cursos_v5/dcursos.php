						...
						<?php if(isset($_GET['InputCrsId'])){ ?>
							...
							<?php if(isset($_GET['InputCrsDepto'])){ ?>
							  <div class="form-group">
						  	  ...
						  	  <?php if($action == 'insert'){echo '<input type="submit" name="guardar" id="guardar" value="Agregar A Curso" class="btn btn-info pull-right">';} 
							}
							?>
						  </div>
				  ...
				  if($vDet["msj"]==true){
					  ...
					  foreach($data as $valor){
				  			...
				  			echo "<tr>
				                  ...
				                  echo '<td><a alt="Eliminar" href="dcursos.php?page='.$page.'&type='.$type.'&eliminar=delete&InputCrsId='.$valor['curso_id'].'&idEmp='.$valor['emp_id'].'"><img alt="Eliminar" src="images/delete-24.png" /></a>&nbsp;&nbsp;</td>
				                </tr>';
